...
namespace uFrame.ECS
{
    public static class EcsSystemExtensions
    {
        ...
        public static void PropertyChanged<TComponentType, TPropertyType>(this EcsSystem system, Func<TComponentType, IObservable<TPropertyType>> select, Action<TComponentType, TPropertyType> handler) where TComponentType : class, IEcsComponent
        {
